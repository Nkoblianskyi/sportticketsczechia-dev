          ...
          <div className="flex flex-col gap-10 text-sm text-muted-foreground leading-relaxed" style={{ fontFamily: 'var(--font-inter)' }}>
            {[
              ...
              },
              {
                ...
                body: 'We collect information you provide directly, including your name, email address, phone number, and any message content when you complete our contact form or book a tour. We also collect technical data automatically when you visit the site, such as your IP address, browser type, pages visited and time on site (via privacy-respecting analytics).',
              },
              {
                title: '3. How We Use Your Data',
                body: 'We use your personal data to: respond to your enquiries and booking requests; fulfil and administer confirmed tours; send you confirmations and essential pre-tour information; improve the quality of our services. We do not use your data for automated profiling or sell it to third parties.',
              },
              {
                title: '4. Legal Basis for Processing (GDPR)',
                body: 'For EU/EEA residents, we process your data based on: (a) the performance of a contract, when you book or enquire about a tour; (b) your consent, for optional marketing communications; (c) our legitimate interests in operating a safe and effective website.',
              },
              {
                title: '5. Data Retention',
                body: 'We retain personal data for as long as necessary to fulfil the purpose it was collected for, or as required by law. Booking-related data is kept for a minimum of 5 years for accounting and legal compliance purposes. Contact form enquiries that do not result in a booking are deleted after 12 months.',
              },
              {
                title: '6. Your Rights',
